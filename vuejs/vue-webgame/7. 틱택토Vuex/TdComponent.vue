...
export default {
    ...
    computed: {
        ...
        // },
        // tableData() {
        //     return this.$store.state.tableData; // store의 state는 computed에서 사용해야함
        // },
        // turn() {
    ...
    methods: {
        onClickTd() {
            ...
            this.$store.commit(CLICK_CELL, { row: this.rowIndex, cell: this.cellIndex }); // mutation은 commit으로 실행
