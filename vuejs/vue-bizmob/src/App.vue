...
import { bizMOB, SET_DEVICE_INFO } from '@/store/bizMOB';
import HelloWorld from './components/HelloWorld';
import SampleCard from './components/SampleCard';

const bizMOBHelper = createNamespacedHelpers(bizMOB);
...
export default {
  ...
  methods: {
    ...bizMOBHelper.mapActions([SET_DEVICE_INFO])
  },
  created() {
    ...
    window.bizMOB = {
      Device: {
        ...
        setInfo: info => this[SET_DEVICE_INFO](info)
      }
    };
    ...
    window.bizMOBCore = {
      ...
      CallbackManager: {
        responser: (callback, response, serviceInfo) =>
          console.log(callback, response, serviceInfo)
      }
    };
